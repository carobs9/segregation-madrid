...
renta = pd.read_csv( # SOURCE = https://ine.es/jaxiT3/Datos.htm?t=31097
    cfg.ROOT_PATH / 'segregation_indices/data/raw/indicadores_renta_2_2021.csv', 
    sep=';', 
    converters={
...
# merged = merged.set_crs(gdf.crs) FIXME: This line of codes gives issues depending on the python version.
